...
<h1>John Decker Scholarship Application</h1>

<form action="/php_advanced_form/process_decker.php" method="post" id="registration" runat="vdaemon">

<vlsummary class="error" headertext="Error(s) found:">
<input type="hidden" name="formID" value="applicants_2016" />
<input type="hidden" name="redirect_to" value="../1thanks_decker.html" />
...
<p style="color: #493d25;">To be considered for the John Decker scholarship<span style="font-weight: 800; "> all</span> of the following <span style="font-weight: 800;">must</span> be included: </p>
